...
$main_url = new moodle_url('/blocks/inlider_report_challenge/clear_main.php',array('id'=>$id));


$mform = new inlider_report_challenge_clear_main($main_url,array('id'=>$id));
...
$title = 'Limpiar todas las Relaciones';
